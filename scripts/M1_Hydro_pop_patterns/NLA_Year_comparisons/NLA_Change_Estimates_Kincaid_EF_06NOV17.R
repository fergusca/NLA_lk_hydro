...
# 12/13/17 - updated to include WRT and WYield - single observations
...
# Recode levels of the WSA9 Ecoregions / Lake Origin (WSA9_LO) variable
levels(changestatus$WSA9_LO) <- list(
   "CPL_MAN_MADE" = c("CPL_MAN-MADE", "CPL_MAN_MADE"),
   "CPL_NATURAL" = "CPL_NATURAL",
   "NAP_MAN_MADE" = c("NAP_MAN-MADE", "NAP_MAN_MADE"),
   "NAP_NATURAL" = "NAP_NATURAL",
   "NPL_MAN_MADE" = c("NPL_MAN-MADE", "NPL_MAN_MADE"),
   "NPL_NATURAL" = "NPL_NATURAL",
   "SAP_MAN_MADE" = c("SAP_MAN-MADE", "SAP_MAN_MADE"),
   "SAP_NATURAL" = "SAP_NATURAL",
   "SPL_MAN_MADE" = c("SPL_MAN-MADE", "SPL_MAN_MADE"),
   "SPL_NATURAL" = "SPL_NATURAL",
   "TPL_MAN_MADE"  = c("TPL_MAN-MADE", "TPL_MAN_MADE"),
   "TPL_NATURAL" = "TPL_NATURAL",
   "UMW_MAN_MADE" = c("UMW_MAN-MADE", "UMW_MAN_MADE"),
   "UMW_NATURAL" = "UMW_NATURAL",
   "WMT_MAN_MADE" = c("WMT_MAN-MADE", "WMT_MAN_MADE"),
   "WMT_NATURAL" = "WMT_NATURAL",
   "XER_MAN_MADE" = c("XER_MAN-MADE", "XER_MAN_MADE"),
   "XER_NATURAL" = "XER_NATURAL")
...
data.cont <- data.frame(siteID=changestatus$SITE_ID,
                        ...
                        E_I=changestatus$E_I,
                        WRT=changestatus$RT_iso,
                        WYIELD=changestatus$Water_yield_m)
