...
write.csv(out_DD_EI_base_min, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/CONUS_0712_LOW_HYDRO_DD_EI_NO_INTERACTION.csv") #summ_WEST_07_sat

# Standardized estimates of bootstrap model
std_parameter_se_bootstrap_min<- standardizedSolution(fit_DD_EI_min)
write.csv(std_parameter_se_bootstrap_min, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/CONUS_0712_LOW_HYDRO_DD_EI_NO_INTERACTION_std_bootstrap_CI.csv")
...
write.csv(out_DD_EI_base_west, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/WEST_0712_HYDRO_DD_EI_NO_INTERACTION.csv") #summ_WEST_07_sat

# Standardized estimates of bootstrap model
std_parameter_se_bootstrap_west<- standardizedSolution(fit_DD_EI_west)
write.csv(std_parameter_se_bootstrap_west, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/WEST_0712_HYDRO_DD_EI_NO_INTERACTION_std_bootstrap_CI.csv")
...
write.csv(out_DD_EI_base_mwest, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/MIDWEST_0712_HYDRO_DD_EI_NO_INTERACTION.csv") #summ_WEST_07_sat

# Standardized estimates of bootstrap model
std_parameter_se_bootstrap_mwest<- standardizedSolution(fit_DD_EI_mwest)
write.csv(std_parameter_se_bootstrap_mwest, "~/NLA_hydro/NLA_hydro_driver/Routput/base_model/MIDWEST_0712_HYDRO_DD_EI_NO_INTERACTION_std_bootstrap_CI.csv")
