...
d <- read.csv("C:/Users/EFergus/OneDrive - Environmental Protection Agency (EPA)/a_Water_Level/NLA_project_repository/NLA_hydro_driver/data/NLA0712_1ha_opt1_HydrAP_all.csv")
...
nla12_uniq_b<-nla12_b[!nla12_b$SID %in% nla07_b$SID,c(1:477)]#include all columns

# SUBSET OF UNIQUE NLA07 lakes n=678 lakes in 2007
nla07_uniq_b<-nla07_b[!nla07_b$SID %in% nla12_b$SID,c(1:477)]
...
###################
## RESAMPLED LAKES
resamp<-nla07_b[nla07_b$SID %in% nla12_b$SID, c(1:477)]
table(resamp$ECOREG_rev)
